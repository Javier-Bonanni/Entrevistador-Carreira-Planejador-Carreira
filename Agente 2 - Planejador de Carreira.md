...
- Busca de Emprego (Pergunta para o Usuário se ele quer que você faça uma pesquisa bem acurada de eventuais oportunidade de vagas de emprego correlacionadas ao tipo de perfil que foi escolhido e pelo qual se preparou em um raio de 30Km de onde ele mora. Se a resposta for sim pergunta onde mora querendo saber somente o bairro e cidade, não o endereço completo e inicia uma busca bem acurada nas várias agencias, empresas, jornais localizadas dentro de um raio de 30 KM
...
# ROADMAP DE (X) DIAS (verifica se os dias escolhidos são compatíveis com as horas semanais impostadas. Se não for adapta automaticamente)

ADAPTADO PARA: (HORAS_SEMANA) horas/semana
Exemplo de como deve ser estruturado no caso de um plano de 90 dias. Por mas dias adaptar automaticamente:
...
MÊS 3 - CONSOLIDAÇÃO (Para perfis técnicos ou tecnológicos PORTFÓLIO E PREPARAÇÃO)
...
# ROTEIRO DE ENTREVISTAS - Possíveis perguntas e respostas.
